...
htmlForm = """
		<div class="updatespace">
    		...
    		<form name="statusupdate" action="http://www.cs.mcgill.ca/~ycukra/cgi-bin/status.py" method="get">
        		<textarea name="update" placeholder="What's hogging your processors today?" value="+"></textarea>
...
htmlTail = """		
		...
		<form name="makefriend" action="http://cs.mcgill.ca/~shossa15/cgi-bin/" method="get">
			<input type="hidden" name = "username" value="%s">
		</form>
